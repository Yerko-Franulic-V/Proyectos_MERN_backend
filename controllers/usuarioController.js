...
const registrar = async (req, res) => {
    ...
    // Valida que vengan los parametros
    ...
    try {
        //Generar Token de creacion para el usuario
...
const olvidePassword = async (req, res) => {
    ...
    if (!usuario.confirmado) {
        const error = new Error('Usuario no ha sido confirmado, revise su buzon de entrada y confirme su Email')
        return res.status(403).json({ msg: error.message })
    }
